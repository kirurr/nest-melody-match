...
import { GoogleAuthProvider, GoogleTokens, GoogleUserData } from './google-auth.provider';

@Injectable()
export class GoogleAuthService {
  constructor(private readonly googleAuthProvider: GoogleAuthProvider) {}

  public async retireveTokensAndUserData(authCode: string): Promise<[GoogleTokens, GoogleUserData]> {
